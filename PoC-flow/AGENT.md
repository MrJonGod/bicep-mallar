...
Then clone the `main.bicep` file.
...
**Agent**: "Perfekt! Jag genererar nu en `.bicepparam`-fil med dessa värden samt clonar `main.bicep`. Resurserna kommer att namnges enligt SX:s standard:
